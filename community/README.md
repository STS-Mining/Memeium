...
We’re all in this together. There are new capabilities included in the latest Phoenix version (3.2+) of Memeium that open up new business opportunities.  Join in and build something.  This is not an exhaustive list, but just a starting point to fire the imagination.  
...
* Core
    * Asset Exchange Proxy (simulate sending an ASSET like memeiumd does for MMM)
...
* Run a contest: MMM prize for best idea for new Memeium based Business
...
* Back-end API platform for Memeium
    * Other people to hit high-availablity API
* Fee system to pay MMM fees automatically
    * Auto-pay fees
    * Can take X% of fees
...
* Auto fee funder (so users of ABC token doesn’t need to worry about fees)
    ...
    * Sends small amount of MMM for fees.
...
* #KYC tagger - store info and tag Memeium addresses
* #ACCREDITED - verify accredited status and tag Memeium addresses
 
### Technical Consultant
* Help companies apply Memeium capabilities to real-world problems
* Security Token Issuance Platform
* Collaborate with exchanges for more listings
* Collaborate with custodial Security Token exchanges for deposit/withdrawal
* Collaborate with hardware wallets for additional MMM and asset support


### Areas for Memeium Innovation
* Financial
