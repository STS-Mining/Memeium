 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Memeium (https://memeium.org/),
...
bool AppInit(int argc, char* argv[])
{
    ...
    try {
        ...
        // -server defaults to true for memeiumd but not for the GUI so do this here
...
#endif
            fprintf(stdout, "Memeium server starting\n");
