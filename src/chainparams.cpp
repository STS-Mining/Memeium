...
public:
    CMainParams()
    {
        ...
        vSeeds.emplace_back("seed-memeium.memeium.org", false);
        ...
        // Memeium BIP44 cointype in mainnet is '175'
        nExtCoinType = 175;
        ...
        chainTxData = ChainTxData{
            // Update as we know more about the contents of the Memeium chain
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("seed-testnet-memeium.memeium.org", false);
        ...
        // Memeium BIP44 cointype in testnet
        nExtCoinType = 1;
...
public:
    CRegTestParams()
    {
        ...
        // Memeium BIP44 cointype in regtest
        nExtCoinType = 1;
