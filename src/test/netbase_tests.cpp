...
BOOST_AUTO_TEST_CASE(netbase_splithost_test)
{
    ...
    BOOST_CHECK(TestSplitHost("www.memeium.org", "www.memeium.org", -1));
    BOOST_CHECK(TestSplitHost("[www.memeium.org]", "www.memeium.org", -1));
    BOOST_CHECK(TestSplitHost("www.memeium.org:80", "www.memeium.org", 80));
    BOOST_CHECK(TestSplitHost("[www.memeium.org]:80", "www.memeium.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8676", "127.0.0.1", 8676));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8676", "127.0.0.1", 8676));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8676", "::ffff:127.0.0.1", 8676));
    BOOST_CHECK(TestSplitHost("[::]:8676", "::", 8676));
    BOOST_CHECK(TestSplitHost("::8676", "::8676", -1));
    BOOST_CHECK(TestSplitHost(":8676", "", 8676));
    BOOST_CHECK(TestSplitHost("[]:8676", "", 8676));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric_test)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8676", "127.0.0.1:8676"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8676", "[::]:8676"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
