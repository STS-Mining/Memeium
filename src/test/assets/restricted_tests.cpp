...
BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test)
{
    ...
    // Create filler mmm tx
    CScript mmmTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
    CTxOut mmmOut(1 * COIN, mmmTransfer);
    ...
    mutTxTest1.vout.emplace_back(mmmOut);
    ...
    mutTxTest2.vout.emplace_back(mmmOut);
    ...
    mutTxTest3.vout.emplace_back(mmmOut);
    ...
    mutTxTest4.vout.emplace_back(mmmOut);
    ...
    mutTxTest5.vout.emplace_back(mmmOut);
    ...
    mutTxTest6.vout.emplace_back(mmmOut);
    ...
    mutTxTest7.vout.emplace_back(mmmOut);
    ...
    mutTxTest8.vout.emplace_back(mmmOut);
