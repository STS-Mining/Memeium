...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatMemeiumURI(info);
    ...
    if (info.amount)
        html += "<b>" + tr("Amount") + "</b>: " + MemeiumUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatMemeiumURI(info));
}
