...
#ifndef MEMEIUM_QT_MEMEIUMUNITS_H
#define MEMEIUM_QT_MEMEIUMUNITS_H
...
*/
class MemeiumUnits : public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MemeiumUnits(QObject* parent);
...
typedef MemeiumUnits::Unit MemeiumUnit;

#endif // MEMEIUM_QT_MEMEIUMUNITS_H
