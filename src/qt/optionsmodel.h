...
#ifndef MEMEIUM_QT_OPTIONSMODEL_H
#define MEMEIUM_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Memeium client.
...
#endif // MEMEIUM_QT_OPTIONSMODEL_H
