...
#ifndef MEMEIUM_QT_MEMEIUMGUI_H
#define MEMEIUM_QT_MEMEIUMGUI_H
...
/**
  Memeium GUI main class. This class represents the main window of the Memeium UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class MemeiumGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit MemeiumGUI(const PlatformStyle* platformStyle, const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~MemeiumGUI();
...
private:
    ...
    QComboBox* comboMmmUnit = nullptr;
