...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    explicit TxViewDelegate(const PlatformStyle* _platformStyle, QObject* parent = nullptr) : QAbstractItemDelegate(parent), unit(MemeiumUnits::MMM),
...
class AssetViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    explicit AssetViewDelegate(const PlatformStyle* _platformStyle, QObject* parent = nullptr) : QAbstractItemDelegate(parent), unit(MemeiumUnits::MMM),
                                                                                                 platformStyle(_platformStyle)
    {
    }
                                                                                  ...
                                                                                  assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->mmmBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->mmmBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(MemeiumUnits::formatWithUnit(unit, balance, false, MemeiumUnits::separatorAlways));
    ui->labelUnconfirmed->setText(MemeiumUnits::formatWithUnit(unit, unconfirmedBalance, false, MemeiumUnits::separatorAlways));
    ui->labelImmature->setText(MemeiumUnits::formatWithUnit(unit, immatureBalance, false, MemeiumUnits::separatorAlways));
    ui->labelTotal->setText(MemeiumUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, MemeiumUnits::separatorAlways));
    ui->labelWatchAvailable->setText(MemeiumUnits::formatWithUnit(unit, watchOnlyBalance, false, MemeiumUnits::separatorAlways));
    ui->labelWatchPending->setText(MemeiumUnits::formatWithUnit(unit, watchUnconfBalance, false, MemeiumUnits::separatorAlways));
    ui->labelWatchImmature->setText(MemeiumUnits::formatWithUnit(unit, watchImmatureBalance, false, MemeiumUnits::separatorAlways));
    ui->labelWatchTotal->setText(MemeiumUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, MemeiumUnits::separatorAlways));
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the MMM balance grid from expanding and looking terrible when asset balance is hidden
