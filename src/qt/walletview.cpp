...
void WalletView::setMemeiumGUI(MemeiumGUI* gui)
{
    if (gui) {
...
void WalletView::setWalletModel(WalletModel* _walletModel)
{
    ...
    if (_walletModel) {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? MemeiumGUI::HD44_ENABLED : _walletModel->hdEnabled() ? MemeiumGUI::HD_ENABLED :
                                                                                                                           MemeiumGUI::HD_DISABLED);
