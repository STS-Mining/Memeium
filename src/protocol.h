...
#ifndef MEMEIUM_PROTOCOL_H
#define MEMEIUM_PROTOCOL_H
...
/**
 * Memeium protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // Memeium Core does not support this but a patch set called Memeium XT does.
    ...
    // Memeium-development mailing list. Remember that service bits are just
