...
#ifndef MEMEIUM_SCRIPT_SCRIPT_H
#define MEMEIUM_SCRIPT_SCRIPT_H
...
public:
    ...
    bool GetOp2(const_iterator& pc, opcodetype& opcodeRet, std::vector<unsigned char>* pvchRet) const
    {
        ...
        // If we see an op mmm asset, we consider all data after it has data, and not op codes
    ...
    /**
     * Pre-version-0.6, Memeium always counted CHECKMULTISIGs
