...
The ZeroMQ feature in Memeium Core requires the ZeroMQ API >= 4.0.0
...
during the *configure* step of building memeiumd:
...
For instance:
    ...
    $ memeiumd -zmqpubhashtx=tcp://127.0.0.1:28766 \
