Memeium Core version *2.2.2* is now available!!
==============

  <https://github.com/STS-Mining/Memeium/releases/tag/v2.2.2>
...
- Enhancements for Memeium Dev Kit and Mobile Wallet Support
