...
NodeConn: an object which manages p2p connectivity to a memeium node
...
class NodeConnCB:
    """Callback and helper functions for P2P connection to a memeiumd node.
...
class NodeConn(asyncore.dispatcher):
    ...
    def __init__(self, dstaddr, dstport, rpc, callback, net="regtest", services=NODE_NETWORK, send_version=True):
        ...
        logger.info('Connecting to Memeium Node: %s:%d' % (self.dstaddr, self.dstport))
