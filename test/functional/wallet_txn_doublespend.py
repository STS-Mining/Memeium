...
class TxnMallTest(MemeiumTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 MMM:
        ...
        # First: use raw transaction API to send 1240 MMM to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 MMM coin each
        ...
        # Node0's balance should be starting balance, plus 50MMM for another
        ...
        # Node0's total balance should be starting balance, plus 100MMM for 
