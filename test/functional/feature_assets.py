...
class AssetTest(MemeiumTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("MEMEIUM1", 1000)
        n0.issue("MEMEIUM2", 1000)
        n0.issue("MEMEIUM3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="MEMEIUM*", verbose=False, count=2, start=-2)
        ...
        memeium_assets = n0.listassets(asset="MEMEIUM*", verbose=False, count=2, start=-2)
        assert_equal(len(memeium_assets), 2)
        assert_equal(memeium_assets[0], "MEMEIUM2")
        assert_equal(memeium_assets[1], "MEMEIUM3")
        self.sync_all()
