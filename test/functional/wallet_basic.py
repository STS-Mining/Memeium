...
class WalletTest(MemeiumTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 MMM from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 MMM with subtract fee from amount
        ...
        # Sendmany 10 MMM with subtract fee from amount
