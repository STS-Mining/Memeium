...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the MemeiumTestFramework
    pass

class ExampleTest(MemeiumTestFramework):
    # Each functional test is a subclass of the MemeiumTestFramework class.
    ...
    def custom_method(self):
        ...
        MemeiumTestFramework class so other tests can use it."""
