...
* for `src/leveldb`: https://github.com/bitcoin-core/leveldb.git (branch memeium-fork)
...
Setup
---------
Configuring the github-merge tool for the memeium repository is done in the following way:

    git config githubmerge.repository memeium/memeium
