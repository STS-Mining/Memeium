...
find ${DISTNAME}/bin -type f -executable -exec ../memeium/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../memeium/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/memeium/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/memeium/depends/SDKs/MacOSX10.11.sdk.tar.gz
