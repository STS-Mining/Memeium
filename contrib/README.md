...
Files used during the gitian build process. For more information about gitian, see the [the Memeium Core documentation repository](https://github.com/STS-Mining/docs).
...
### [RPM](/contrib/rpm) ###
RPM spec file for building memeium-core on RPM based distributions.
...
This script attempts to download and verify the signature file SHA256SUMS.asc from memeium.org.
